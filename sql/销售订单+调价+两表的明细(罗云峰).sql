...
(
  ...
  PrdSuggestPrice	number(*,2) not null,
  PrdSalesPriceA	number(*,2),
  PrdSalesPriceB	number(*,2),
  PrdSalesPriceC	number(*,2),
  PrdSalesPriceD	number(*,2),
  PrdSalesPriceE	number(*,2),
  PrdStdPrice	number(*,2) not null,
  PrdBusiTaxRate	number(*,2) not null,
...
(
  ...
  Amount	number(*,2) not null,
  MlAmount	number(*,2) not null,
  TaxRate	number(*,2) not null,
  TaxAmt	number(*,2) not null,
  MlTaxAmt	number(*,2) not null,
  VFTotal	number(*,2) not null,
  MlVFTotal	number(*,2) not null,
