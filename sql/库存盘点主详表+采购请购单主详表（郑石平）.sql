...
CREATE TABLE t_Stock_Inventory(
...
Zerofilter number(1) ,
Sumcurqty NUMBER(22) ,
Sumcheckqty NUMBER(22),
Makersign varchar2(20) ,
Permittersign varchar2(20),
static number(1)
);
...
/*库存盘点详表*/
CREATE TABLE t_Stock_Inventory_details(
detailsId varchar2(20) primary key,
billno varchar2(20) ,
Prodid varchar2(20) ,
Prodsire varchar2(20) ,
stdunitid varchar2(20) ,
Bookquantity NUMBER(22),
InventoryNumber NUMBER(22),
Profitandloss NUMBER(22) ,
UnitPrice number(*,2),
Profitandlossamount number(*,2) ,
...
Remark varchar2(255) ,
Sumqty  NUMBER(22) ,
Headerid varchar2(20) ,
Headername varchar2(20) ,
Footerid  varchar2(20) ,
Footername  varchar2(20) , 
